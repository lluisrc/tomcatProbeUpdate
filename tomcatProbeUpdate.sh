...
probeSource=""
catalinaJarSource=""
# Faltan que el scp se pueda copiar el directorio
actualizarTomcat () {
...
scp opertec@192.168.252.180:/home/opertec/tomcat-8.5.72.A.RELEASE /opt/pivotal/pivotal-tc-server-standard/ # no va bien por que no es un directorio
